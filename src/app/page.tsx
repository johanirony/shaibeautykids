  ...
  return (
    <main className=" w-full h-full bg-[#FBF2E9]  ">
      ...
      <div className="w-full h-full bg-inherit">
        ...
        Introducing Shai Beauty® Kids! Created with a scientific understanding of developing kids' skin and hair, with self-care products that prepare them for their widening world. And as kids gain independence, they also gain confidence knowing they can take care of themselves
        </p>
