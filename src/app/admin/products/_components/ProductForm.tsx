    ...
    return (
        <form action={action} className="space-y-8">
            ...
            <div className="space-y-2">
                ...
                <Input type="Number" id="priceInRupees" name="priceInRupees" required value={priceInRupees} onChange={e => setPriceInRupees(Number(e.target.value)|| undefined)}/>
            ...
            <div className="space-y-2">
                ...
                {
                    product != null && <Image src={product.imagePath} alt="" height={200} width={200}/>
                }
